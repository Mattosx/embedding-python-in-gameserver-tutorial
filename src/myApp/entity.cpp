...
static PyObject *_createEntity(PyObject *self, PyObject *args)
{
	...
	if (PyObject_HasAttrString(pObject, "__init__"))
	{
		PyObject *pyResult = PyObject_CallMethod(pObject, const_cast<char *>("__init__"), const_cast<char *>(""));
		if (pyResult != NULL)
		{
			Py_DECREF(pyResult);
		}
...
PyTypeObject Entity::_typeObject = {
	PyVarObject_HEAD_INIT(NULL, 0) "Entity", /* tp_name */
